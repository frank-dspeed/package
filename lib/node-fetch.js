...
import { c as commonjsGlobal } from './dependencies-_commonjsHelpers.js';
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await import('./dependencies-multipart-parser.js');
...
export { AbortError, Blob$1 as Blob, FetchError, File$1 as File, FormData, Headers, Request, Response, blobFrom, blobFromSync, fetch as default, fetch, fileFrom, fileFromSync, isRedirect };
